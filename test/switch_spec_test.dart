...
void main() {
  test('theme defaults match the switch spec', () {
    ...
    expect(
      theme.thumbColor(scheme, enabled: false, value: true),
      scheme.surface,
    );
  ...
  testWidgets('control is a 48dp target around a 52dp track', (tester) async {
  ...
  testWidgets('off handle with an icon is 24dp', (tester) async {
  ...
  testWidgets('drag past the midpoint toggles on', (tester) async {
    var value = false;
  ...
  testWidgets('space toggles the focused switch', (tester) async {
    var value = false;
  ...
  testWidgets('semantics expose a toggled switch', (tester) async {
    await tester.pumpWidget(
