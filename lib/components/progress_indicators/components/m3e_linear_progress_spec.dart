...
@immutable
class M3ELinearProgressSpec {
  const M3ELinearProgressSpec({
...
/// Returns the [M3ELinearProgressSpec] for the given [size] and [shape].
///
/// Port of the reference `specForLinear`.
M3ELinearProgressSpec m3eSpecForLinear({
